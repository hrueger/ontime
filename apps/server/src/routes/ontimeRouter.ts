...
// create route between controller and '/ontime/sheets-sync' endpoint
router.get('/sheets-sync', getSheetsSyncSettings);

// create route between controller and '/ontime/sheets-sync' endpoint
router.post('/sheets-sync', postSheetsSyncSettings);
